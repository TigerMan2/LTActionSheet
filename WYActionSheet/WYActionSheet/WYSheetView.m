...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WYSheetCell *sheetCell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([WYSheetCell class])];
    if (!sheetCell) {
        sheetCell = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([WYSheetCell class]) owner:self options:nil].lastObject;
        if (_cellTextColor) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WYSheetCell *sheetCell = (WYSheetCell *)[tableView cellForRowAtIndexPath:indexPath];
