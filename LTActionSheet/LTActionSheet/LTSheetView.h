...
//代理方法
@protocol LTSheetViewDelegate <NSObject>
...
@interface LTSheetView : UIView <UITableViewDelegate,UITableViewDataSource>
...
@property (nonatomic , assign) id <LTSheetViewDelegate> delegate;
